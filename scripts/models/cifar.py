...
class TeacherModelMediumCIFAR(nn.Module):
    def __init__(self, input_size=32): # input_size = 32 for CIFAR-10
        super(TeacherModelMediumCIFAR, self).__init__()
...
class TeacherModelSmallCIFAR(nn.Module):
    def __init__(self, input_size=32):
        super(TeacherModelSmallCIFAR, self).__init__()
...
class TeacherModelLargeCIFAR(nn.Module):
    def __init__(self, input_size=32):
        super(TeacherModelLargeCIFAR, self).__init__()
        self.conv1 = nn.Conv2d(3, 16, kernel_size=3, padding=1)
